...
public interface SpringDataConsultaRepository extends JpaRepository<Consulta, Long> {
    ...
    @Query("""
            ...
            """)
    Boolean existsConsultaActivaEnFecha(@Param("idPaciente") Long idPaciente, @Param("fecha") LocalDateTime fecha);
    ...
    @Query("""
            ...
            and c.motivoCancelamiento is null
            """)
    Boolean existsConsultaActivaMedicoEnFecha(@Param("idMedico") Long idMedico, @Param("fecha") LocalDateTime fecha);
    ...
    @Query("""
            ...
            order by c.fecha
            """)
    List<Consulta> findConsultasProximasACaducar(@Param("ahora") LocalDateTime ahora,
